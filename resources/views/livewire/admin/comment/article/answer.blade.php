        ...
        <div class="show-comment">
            <div class="ct__header">
                <div class="comment-info">
                    <a class="back" href="{{ route('comment.article.index') }}"></a>
                    <div>
                        <p class="comment-name"><a>مقاله:{{ $comment->article->title }}</a></p>
                    </div>
                </div>
            </div>
            <div class="transition-comment">
                <div class="transition-comment-header">
                    ...
                    <span class="nav-comment-status">
                        <p class="username">کاربر : {{ $comment->user->name ?? $comment->name}}</p>
