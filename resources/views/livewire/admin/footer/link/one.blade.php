...
<div>
    <div class="main-content" wire:init='loadOne'>

        <div class="tab__box">
            <div class="tab__items">
                <a class="tab__item is-active" href="{{ route('one.index') }}">فوتر لینک یک </a>
        ...
        <div class="row">
            <div class="col-8 margin-left-10 margin-bottom-15 border-radius-3">
                ...
                <div class="table__box">
                    <table class="table">
                        ...
                        <tbody>
                            @if ($readyToLoad)
                            @forelse ($FooterlinkOnes as $footer)
                            <tr role="row">
                                <td>{{ $footer->id }}</td>
            ...
            <div class="col-4 bg-white">
                ...
                <form wire:submit.prevent="one" class="padding-10">

                    <div class="form-group">
                        <select wire:model.lazy='FooterlinkOne.page_id' name="page_id" class="form-control">
                            <option value="-1">انتخاب صفحه برای فوتر _</option>
                            @foreach (\App\Models\page::all() as $page)
                            <option value="{{ $page->id }}">{{ $page->title }}</option>
                            @endforeach
                        </select>
                        @error('FooterlinkOne.page_id')
