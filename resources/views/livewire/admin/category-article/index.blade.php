    ...
    <div class="main-content" wire:init='loadCategory'>
        ...
        <div class="tab__box">
            <div class="tab__items">
                ...
                <a class="tab__item"
                    href="{{ route('subcategory.article.index') }}">زیر دسته های مقالات</a>
            ...
            >سطل زباله
            ({{ \App\Models\categoryArticle::onlyTrashed()->count() }})
            </a>
        </div>
                        ...
                        <tbody>
                            ...
                            <tr role="row">
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('category.article.update',$category) }}" class="item-edit "
                                        title="ویرایش"></a>
                                </td>
                            </tr>
                            @empty
            ...
            <div class="col-4 bg-white">
                ...
                <form wire:submit.prevent="category" class="padding-10" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <input wire:model.lazy='category.title' type="text" placeholder="نام دسته " class="form-control" name="link">
