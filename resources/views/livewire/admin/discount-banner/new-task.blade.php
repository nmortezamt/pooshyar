@section('title','تسک جدید تخفیفات')
        ...
        <div class="tab__box">
            <div class="tab__items">
                ...
                <a class="tab__item "
                    ...
                    <a class="tab__item" href="{{ route('special.discount') }}">تخفیف ویژه </a>

                    <a class="tab__item is-active" href="{{ route('newTask.index') }}">تسک جدید </a>
        </div>
                    ...
                    <div class="form-group">
                        <div class="notificationGroup">
                            <input wire:model.lazy='Discount.status' type="checkbox" id="option4" class="form-control"
                                name="status">
                            <label for="option4">نمایش در صفحه اصلی</label>
                        </div>
                    </div>
