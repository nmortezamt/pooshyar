                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr role="row">
                                    ...
                                    <td>
                                            @foreach (\App\Models\product::where('id',$attributeValue->product_id)->get() as $product)
                                            {{ $product->title }}
                                            @endforeach
                                ...
                                <td>
                                    ...
                                    <td>
                                       ...
                                       <a wire:click='restorecategory({{ $attributeValue->id }})' class="item-li i-checkouts item-restore" title="بازیابی"> </a>
                                    </td>
                                </tr>
                                @endforeach
