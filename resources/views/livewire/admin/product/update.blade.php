    ...
    <div class="main-content">
        <div class="row">
            <div class="col-12 bg-white">
                    <p class="box__title">ویرایش محصول _{{ $product->title }} </p>
                <form wire:submit.prevent="product" class="padding-30" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <select wire:model.lazy='product.subcategory_id' class="form-control" name="subcategory_id">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <input wire:model.lazy='product.link' type="text" placeholder="لیتک محصول"
                                    class="form-control">
                                @error('product.link')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                        ...
                        <div class="form-group" wire:ignore>
                            <textarea wire:model.lazy='product.description' type="text" placeholder=" توضیح کوتاه محصول"
                        ...
                        <div class="form-group" wire:ignore>
                            <textarea wire:model.lazy='product.body' type="text" placeholder=" توضیح محصول"
                        ...
                        <div class="form-group">
                            <textarea wire:model.lazy='product.description_seo' type="text" placeholder=" توضیح سئو محصول"
                                class="form-control" id="description" name="description">
                            </textarea>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <input wire:model.lazy='product.discount_price' type="text"
                                        placeholder="قیمت تخفیف خورده محصول" class="form-control">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <div class="notificationGroup">
                                    <input wire:model='product.shipment' type="checkbox" id="option7" class="form-control"
                                        name="shipment">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <div class="notificationGroup">
                                    <input wire:model='product.publish' type="checkbox" id="option6" class="form-control"
                                        name="publish">
                    ...
                    <div>
                        ...
                        @elseif ($product->img)
                        <img src="/uploads/{{ $product->img}}" width="200" class="form-control" style="width: 400px">
                        @endif
                    </div>
                    <br>
