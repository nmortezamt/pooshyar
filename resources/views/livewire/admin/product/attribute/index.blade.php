    ...
    <div class="main-content" wire:init='loadCategory'>
        ...
        <div class="tab__box">
            <div class="tab__items">
                <a class="tab__item is-active" href="{{ route('attribute.index') }}">مشخصات کالا </a>
                <a class="tab__item" href="{{ route('attributevalue.index') }}"> مقدار مشخصات کالا </a>
