                            ...
                            @if ($readyToLoad)
                                @forelse ($orders as $order)
                                    ...
                                    <tr role="row">
                                        ...
                                        <td>
                                            @foreach (\Modules\Product\Product\Models\product::where('id',$order->product_id)->get() as $product)
                                                {{ $product->title }}
                                            @endforeach
                                        </td>
                                        ...
                                        <td>
                                            @foreach (\Modules\User\Models\user::where('id',$order->user_id)->get() as $user)
                                                @if ($user->name)
                                                    {{ $user->name .'='. $user->id}}
