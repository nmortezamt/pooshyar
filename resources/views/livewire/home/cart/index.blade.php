                                ...
                                <tbody>
                                    ...
                                    <tr wire:key="{{ $cart->id }}">
                                        ...
                                        <td class="product-name" data-title="رنگ">
                                            <div class="pr_switch_wrap" wire:ignore>
                                                <div class="product_color_switch">
                                                    @if ($cart->type
                                                     == 'single')
                                                        ...
                                                        foreach ($color_name as $name => $id) {
                                                            $value_color = \App\Models\color::where('id',$id)->first();
                                                            $name_color = \App\Models\color::where('id',$id)->first();
                                                        }
                                                        @endphp
                                                    ...
                                                    @forelse (\App\Models\color::where('product_id',$cart->product_id)->get() as $color)
                                        ...
                                        <td class="product-name" data-title="سایز">
                                            <div class="pr_switch_wrap">
                                                <div class="product_size_switch">
                                                    ...
                                                    <span>{{ $NameSize }}</span>
                                                    @else
                                                    @forelse (\App\Models\size::where('product_id',$cart->product_id)->get() as $size)
                                                    <span>{{ $size->name ?? ''}}</span>
                                                    @empty
                                        ...
                                        <td class="product-price" data-title="قیمت">
                                            ...
                                            <del>{{ \App\Models\persianNumber::translate(number_format($cart->product_price)) }} تومان</del>
                                            @else
                                        ...
                                        <td class="product-quantity" data-title="تعداد">
                                            <div class="quantity">
                                                <button type="button" class="minus"
                                                    wire:click="removeToCount({{ $cart->id }})">-</button>
                                                    <div wire:loading wire:target="removeToCount({{ $cart->id }})">
                                                        <i class="fas fa-spinner fa-spin"></i>
                                                    </div>
                                                <input type="text" name="quantity" value="{{ \App\Models\persianNumber::translate($cart->count) }}"
                                                    title="تعداد" class="qty" size="4" disabled>
                                                <button class="plu" wire:click="addToCount({{ $cart->id }})">+</button>
                                        ...
                                        <td class="product-remove" wire:click='removeCart({{ $cart->id }})'data-title="حذف" >
