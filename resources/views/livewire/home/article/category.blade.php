...
<div class="main_content">
    ...
    <div class="section">
        <div class="container">
            <h4>مقالات <span style="color: #FF324D">{{ $category->title }}</span></h4>
                ...
                <div class="col-lg-3 mt-4 pt-2 mt-lg-0 pt-lg-0">
                    <div class="sidebar">
                        <div class="widget">
                            ...
                            <h6 class="widget_title" style="color: #FF324D">{{ $category->title }}</h6>
                            <ul class="widget_archive">
                                @foreach (\App\Models\subcategoryArticle::where('category_article_id',$category->id)->get() as $subcategory)
