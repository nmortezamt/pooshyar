...
<div class="section pb_20">
    <div class="container">
        ...
        <div class="row justify-content-center">
            @forelse (\Modules\Blog\Models\blog::where('status',1)->latest()->take(3)->get() as $article)
                        ...
                        <div class="blog_content bg-white">
                            <div class="blog_text">
                                <h5 class="blog_title"><a
                                        href="{{route('article.single.index',$article->link)}}">{{ $article->title }}</a>
                                </h5>
                                <ul class="list_none blog_meta">
                                    <li>
                                        <a><i class="ti-calendar"></i> {{\App\Models\persianNumber::translate( jdate($article->created_at)->format('%B %d ,%Y')) }}
                                        </a></li>
                                    <li><a><i class="ti-comments"></i>دیدگاه
                                            ({{ \App\Models\commentArticle::where([['status',1],['article_id',$article->id]])->count()}}
                                            )</a></li>
                                </ul>
                                <div>
