...
<!-- END HEADER -->
    ...
    <div class="main_content">
        ...
        <div class="section">
            <div class="container">
                <h1 class="title_product">محصولات :{{ $category->title }}</h1>
                                        ...
                                        {{-- <div class="custom_select">
                                            <select class="form-control form-control-sm">
                                                ...
                                                <option value="date">مرتب سازی بر اساس جدید بودن
                                                                                ...
                                                                                <option value="price">مرتب سازی بر اساس قیمت: کم به زیاد
                                                </option>
                                    ...
                                    <div class="product_img">
                                        ...
                                        <div class="product_action_box">
                                            <ul class="list_none pr_action_btn">
                                                <li class="add-to-cart"><a href="{{ route('product.single.index', ['id'=>$product->id ,'link' =>$product->link])}}"><i class="icon-basket-loaded"></i> مشاهده محصول
                                                </a></li>
