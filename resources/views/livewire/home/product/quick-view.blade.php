                ...
                <div class="product-image">
                    ...
                    <div id="pr_item_gallery" class="product_gallery_item slick_slider" data-slides-to-show="4"
                        ...
                        @forelse ($galleries as $gallery)
                            <div class="item">
                                <a class="product_gallery_item active" data-image="/uploads/{{ $gallery->img }}"
                    ...
                    <div class="product_description">
                        ...
                        <div class="product_price">
                            @if ($product->discount_price)
                                ...
                                <del>{{ \App\Models\persianNumber::translate(number_format($product->price)) }}تومان
                                </del>
                                <div class="on_sale">
                        ...
                        <div class="product_sort_info">
                            <ul>
                                ...
                                @if ($product->number < 10)
                                    <li><i class="linearicons-sync"></i>
                                        فقط {{ \App\Models\persianNumber::translate($product->number)}} در انبار باقی
                                        مانده
                                    </li>
                                @endif
                        ...
                        <div class="cart_extra">
                            ...
                            <div class="cart_btn">
                                <button class="btn btn-fill-out btn-addtocart" type="button"><i
                                            class="icon-basket-loaded"></i> به سبد خرید اضافه کنید
                                </button>
                            ...
                            <ul class="social_icons">
                                @forelse (\App\Models\social::all() as $social)
                                    <li><a href="/{{ $social->link }}"><i
                                                    class="ion-social-{{ $social->type }}"></i></a></li>
                                @empty
