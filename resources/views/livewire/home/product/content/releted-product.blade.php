...
<div class="row">
    <div class="col-12" >
        ...
        <div class="releted_product_slider carousel_slider owl-carousel owl-theme" data-margin="20" data-responsive='{"0":{"items": "1"}, "481":{"items": "2"}, "768":{"items": "3"}, "1199":{"items": "4"}}'>
            @forelse (\App\Models\product::where('status',1)->where('category_id',$category->id)->where('id','<>',$product->id)->latest()->take(20)->get() as $proReleted)
            @php
                $countCommentRelated =
                ...
                <div class="product">
                    <div class="product_img">
                        <a href="{{ route('product.single.index',['id'=>$proReleted->id,'link'=>$proReleted->link]) }}">
                            <img src="/uploads/{{ $proReleted->img }}" alt="{{ $proReleted->title }}" class="resize_image">
                        </a>
                    ...
                    <div class="product_info">
                        <h6 class="product_title"><a href="{{ route('product.single.index',['id'=>$proReleted->id,'link'=>$proReleted->link]) }}">{{ $proReleted->title }}</a></h6>
                        ...
                        <div class="product_price">
                            ...
                            <del>{{ \App\Models\persianNumber::translate(number_format($proReleted->price)) }} تومان</del>
                            <div class="on_sale">
                        ...
                        <div class="pr_switch_wrap">
                            <div class="product_color_switch">
                                @forelse (\App\Models\color::where('product_id',$proReleted->id)->get() as $color)
