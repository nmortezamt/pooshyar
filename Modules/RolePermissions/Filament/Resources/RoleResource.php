...
namespace Modules\RolePermissions\Filament\Resources;
...
class RoleResource extends Resource implements HasShieldPermissions
{
    ...
    {
        return [
            'index' => \Modules\RolePermissions\Filament\Resources\RoleResource\Pages\ListRoles::route('/'),
            'create' => \Modules\RolePermissions\Filament\Resources\RoleResource\Pages\CreateRole::route('/create'),
            'view' => \Modules\RolePermissions\Filament\Resources\RoleResource\Pages\ViewRole::route('/{record}'),
            'edit' => \Modules\RolePermissions\Filament\Resources\RoleResource\Pages\EditRole::route('/{record}/edit'),
        ];
    }
